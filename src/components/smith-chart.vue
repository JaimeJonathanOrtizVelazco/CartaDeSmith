  ...
  >
    ...
    >
      ...
      <g stroke="black" stroke-width=".5" fill="none">
        ...
        <sm-react-arc :double="true" :react="10" />
      ...
      <!-- THICK LINES -->
      <g class="arc" stroke="black" stroke-width="1" fill="none">
        <!--  HORIZONTAL LINE -->
        ...
        <!-- CONSTANT REACTANCE CIRCLES -->
        <g mask="url(#res-circle-0.2)">
          <sm-react-arc :double="true" :react="0.05" />
          <sm-react-arc :double="true" :react="0.15" />
        </g>

        <g mask="url(#res-circle-1)">
          <sm-react-arc :double="true" :react="0.1" />
          <sm-react-arc :double="true" :react="0.3" />
          <sm-react-arc :double="true" :react="0.5" />
          <sm-react-arc :double="true" :react="0.7" />
          <sm-react-arc :double="true" :react="0.9" />
        </g>

        <g mask="url(#res-circle-2)">
          <sm-react-arc :double="true" :react="0.2" />
          <sm-react-arc :double="true" :react="0.4" />
          <sm-react-arc :double="true" :react="0.6" />
          <sm-react-arc :double="true" :react="0.8" />
          <sm-react-arc :double="true" :react="1.2" />
          <sm-react-arc :double="true" :react="1.4" />
          <sm-react-arc :double="true" :react="1.6" />
          <sm-react-arc :double="true" :react="1.8" />
        </g>

        <g mask="url(#res-circle-5)">
          <sm-react-arc :double="true" :react="1" />
          <sm-react-arc :double="true" :react="2" />
          <sm-react-arc :double="true" :react="3" />
          <sm-react-arc :double="true" :react="4" />
        </g>

        <g mask="url(#res-circle-10)">
          <sm-react-arc :double="true" :react="5" />
        </g>

        <g mask="url(#res-circle-20)">
          <sm-react-arc :double="true" :react="10" />
          <sm-react-arc :double="true" :react="20" />
        </g>

        <sm-react-arc :double="true" :react="50" />
      </g>

      <g :transform="'translate(' + radius + ' ' + radius + ')'">
        <g v-if="labelRings" stroke="black" stroke-width="0.5" fill="none">
        ...
        <!-- TEXT LABELS -->
        <g class="text-labels" text-anchor="middle" dominant-baseline="central">
          <g v-if="labelRings">
            <text
              v-for="n in 36"
            ...
            >
              ...
              <text :y="-radius - 48" v-if="n != 1">
                {{ (0.5 - (n - 1) * 0.01).toFixed(2) }}
              </text>
          ...
          >
            <sm-res-label v-for="n in 10" :res="0.1 * n" :key="'01' + n" />

            <sm-res-label v-for="n in 5" :res="0.2 * n + 1" :key="'02' + n" />

            <sm-res-label v-for="n in 3" :res="n + 2" :key="'1' + n" />

            <sm-res-label v-for="n in 2" :res="10 * n" :key="'10' + n" />
        ...
        <g v-if="labelRings" stroke-width="0.5" stroke="black">
          <line
            v-for="n in 180"
